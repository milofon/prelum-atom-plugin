...
function render(self) {
  ...
  var renderLeaf = function (item) {
    ...
    if (item.number) {
      ...
      number.setAttribute('class', 'tree-leaf-number p-link');
      number.textContent = item.number
      number.setAttribute('href', '#' + item.id);
    ...
    body.setAttribute('class', 'tree-leaf-body');

    text.setAttribute('class', 'tree-leaf-text p-link');
    text.setAttribute('href', '#' + item.id);
