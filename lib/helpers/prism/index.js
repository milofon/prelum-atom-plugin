...
! function () {
	if ("undefined" != typeof self && self.Prism && self.document && document.createElement) {
		...
		var n = Prism.plugins.autoloader = {
			...
			i = function (e) {
				return "atom://prelum/resources/prism/components/prism-" + e + (n.use_minified ? ".min" : "") + ".js"
			},
			l = function (e, c) {
				var s = a[e];
				s || (s = a[e] = {});
			...
			u = function (c, r, t) {
				var n = function () {
					...
					var n = a[c];
					if (n || (n = a[c] = {}), r && (n.success_callbacks || (n.success_callbacks = []), n.success_callbacks.push(r)), t && (n.error_callbacks || (n.error_callbacks = []), n.error_callbacks.push(t)), !e && Prism.languages[c]) p(c);
